...
Rails.application.config.sorcery.submodules = [:external] #[:remember_me, :reset_password, :user_activation, :session_timeout, :brute_force_protection, :activity_logging]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `[]`
  #
  config.external_providers = [:twitter, :linkedin, :facebook, :google]
  ...
  config.linkedin.key = IONIC_CONFIG[:linkedin][:key]
  config.linkedin.secret = IONIC_CONFIG[:linkedin][:secret]
  config.linkedin.callback_url = IONIC_CONFIG[:linkedin][:callback_url]
  config.linkedin.user_info_fields = %w[first-name last-name email-address]
  config.linkedin.user_info_mapping = IONIC_CONFIG[:linkedin][:user_info_mapping]
  config.linkedin.access_permissions = IONIC_CONFIG[:linkedin][:access_permissions]
  ...
  config.twitter.key = IONIC_CONFIG[:twitter][:key]
  config.twitter.secret = IONIC_CONFIG[:twitter][:secret]
  config.twitter.callback_url = IONIC_CONFIG[:twitter][:callback_url]
  config.twitter.user_info_mapping = IONIC_CONFIG[:twitter][:user_info_mapping]

  config.facebook.key = IONIC_CONFIG[:facebook][:key]
  config.facebook.secret = IONIC_CONFIG[:facebook][:secret]
  config.facebook.callback_url = IONIC_CONFIG[:facebook][:callback_url]
  config.facebook.user_info_mapping = IONIC_CONFIG[:facebook][:user_info_mapping]
  config.facebook.user_info_path = 'me?fields=id,name,email,first_name,last_name'
  config.facebook.access_permissions = IONIC_CONFIG[:facebook][:access_permissions]
  ...
  config.google.key = IONIC_CONFIG[:google][:key]
  config.google.secret = IONIC_CONFIG[:google][:secret]
  config.google.callback_url = IONIC_CONFIG[:google][:callback_url]
  config.google.user_info_mapping = IONIC_CONFIG[:google][:user_info_mapping]
